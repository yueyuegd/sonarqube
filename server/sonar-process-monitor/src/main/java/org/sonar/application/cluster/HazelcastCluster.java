...
public class HazelcastCluster implements AutoCloseable {
  ...
  private HazelcastCluster(Builder builder) {
    // Create the Hazelcast instance
    hzInstance = Hazelcast.newHazelcastInstance(builder.hzConfig);
  ...
  boolean isOperational(@Nonnull ProcessId processId) {
  ...
  void setOperational(@Nonnull ProcessId processId) {
  ...
  static Builder builder(ClusterProperties clusterProperties) {
    return new Builder(clusterProperties);
  }

  static class Builder {
    private Config hzConfig = new Config();

    private Builder(ClusterProperties clusterProperties) {
